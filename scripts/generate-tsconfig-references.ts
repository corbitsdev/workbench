...
//    packages like `@corbits/connections` -- so a package upstream of
//    `connections` whose *tests* import the harness would otherwise put
 ...
 * (`harness.ts` imports `@corbits/connections`), so they can never
