...
// there. `dom-environment.ts` (preloaded via bunfig.toml) supplies the DOM;
...
} from "../../src/shell/layout/breakpoints";
import { useShellLayoutMode } from "../../src/shell/layout/use-shell-layout";
