...
// dom-environment.ts) rather than reasoned about via `nextTypingState` alone —
...
import { useTypingIndicator } from "../../src/chat/typing-indicator";
import type { TypingState } from "../../src/chat/typing-indicator";
