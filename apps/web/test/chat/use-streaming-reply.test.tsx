...
// dom-environment.ts) rather than reasoned about via `nextStreamingReplyState`
...
import { useStreamingReply } from "../../src/chat/streaming-reply";
import type { StreamingReplyState } from "../../src/chat/streaming-reply";
