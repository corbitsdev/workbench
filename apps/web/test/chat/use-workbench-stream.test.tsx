...
// dom-environment.ts) with a controllable `EventSource` stand-in so the hook's
...
import { parseStreamEventJson, useWorkbenchStream } from "../../src/chat/use-workbench-stream";
