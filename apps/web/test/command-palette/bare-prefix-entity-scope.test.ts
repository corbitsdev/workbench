...
import { isBareScopeQuery, parsePaletteQuery } from "../../src/command-palette/scope";
import { searchEntities } from "../../src/command-palette/entity-search";
import { buildCommandPaletteGroups } from "../../src/command-palette/command-groups";
