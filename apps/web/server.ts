// Minimal production server for the GTM Workbench web SPA.
...
const API_URL = process.env["VITE_API_BASE_URL"]?.replace(/\/+$/, "") || "http://localhost:4000";
...
async function handleRequest(req: Request): Promise<Response> {
  ...
  // Proxy API requests to the hub backend
