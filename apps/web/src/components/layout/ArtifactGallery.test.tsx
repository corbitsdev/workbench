...
const mockContextValue: React.ComponentProps<typeof ChatLauncherContext.Provider>['value'] = {
  hidden: false,
  setHidden: () => {},
  notifyProvisioned: () => {},
  registerReconnect: () => {},
...
describe('ArtifactGallery', () => {
  ...
  describe('CL-1889: Open in Myra flow', () => {
    ...
    it('opens the Myra chat seeded with a reference when "Open in Myra" is clicked in the artifact modal', async () => {
      ...
      fireEvent.click(await screen.findByRole('button', { name: /Open Sales automation ROI/i }));
