...
let ctx: {
  workbenches: { id: string; tenantSlug: string; tenantName: string; tenantId: string }[];
  loading: boolean;
...
describe('WorkbenchSelector', () => {
  ...
  it('shows the active workbench and switches tenancy on select', () => {
    ctx = {
      workbenches: [
        { id: 'p1', tenantSlug: 'acme', tenantName: 'Acme Corp', tenantId: 't1' },
        { id: 'p2', tenantSlug: 'globex', tenantName: 'Globex', tenantId: 't2' },
      ],
      loading: false,
