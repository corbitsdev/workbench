...
export const SETTINGS_STRINGS = {
  ...
  peopleInviteAction: "Invite",
  peopleInviteDialogTitle: "Invite someone",
  peopleInviteDialogDescription: "They need an existing account on this platform to accept.",
  peopleInviteEmailLabel: "Email",
  peopleInviteSubmit: "Send invite",
  ...
  modelsSectionDescription: "Providers and model offerings resolved for this workbench.",
  modelsLoadError: "this workbench's model catalog",
  modelsEmptyTitle: "No models available",
  modelsEmptyDescription: "No provider has offered a model to this workbench yet.",
  modelsProvidersEmptyTitle: "No providers yet",
  modelsProvidersEmptyDescription: "No credential providers are configured on this workbench.",
  modelsProvidersHeading: "Providers",
  modelsCatalogHeading: "Model offerings",
  modelsProviderColumn: "Provider",
  modelsModelColumn: "Model",
  modelsOfferingsColumn: "Offered by",
  modelsDefaultBadge: "Default",
} as const;
