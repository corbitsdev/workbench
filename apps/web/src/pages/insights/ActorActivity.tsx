...
function ActorRow({ actor, onSelect }: { actor: Actor; onSelect: () => void }) {
  return (
    <button
      type="button"
      onClick={onSelect}
      className="flex w-full items-center gap-3 rounded-[8px] px-3 py-2 text-left outline-none transition-[colors,transform] hover:bg-row-hover focus-visible:ring-1 focus-visible:ring-accent active:scale-[0.97]"
    >
