...
export function InsightsDashboard() {
  ...
  return (
    <PagePanel fitContent flat>
      <div className="sticky top-0 z-10 flex flex-wrap items-center justify-between gap-3 border-b border-border bg-surface px-5 py-3 max-md:px-3">
