...
import { resolveRoutineSegment, RoutineDetailPage } from "./routine-detail-page";
...
describe("RoutineDetailRoute", () => {
  ...
  async function renderRoute(
    ...
    const { BenchProvider } = await import("../bench-context");
    const { RoutineDetailRoute } = await import("./routine-detail-page");
