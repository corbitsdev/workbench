...
import { InferenceSettingsApiError } from "@/settings/inference";
...
const WorkbenchWire = type({
  ...
  // this tenant via the shared-workbench machinery: "shared via
