...
/** True for `/w/:id/settings` and `/w/:id/settings/:section` (the workbench
 ...
 * scoped to a section (`/w/:id/settings/:section`) for a deep link straight
 * to that tab. */
...
/** Extract the section id from `/w/:id/settings/:section` (or its legacy
