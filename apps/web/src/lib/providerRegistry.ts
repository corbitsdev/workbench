...
const FIRECRAWL: ProviderMeta = {
  ...
  label: "Firecrawl",
  description:
    "Scrape, crawl, map, search, and extract web data with Firecrawl.",
  fields: [
    {
      key: "apiKey",
      label: "API key",
  ...
  tools: [
    ...
    },
    {
      name: "firecrawl_map",
      label: "map",
      description: "Map all URLs from a domain.",
    },
    {
    ...
    },
    {
      ...
      label: "crawl active",
      description: "List active crawl pages.",
    },
    {
