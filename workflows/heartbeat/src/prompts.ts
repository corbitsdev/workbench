...
- If the call notes were skipped (the tool result has \`"skipped": true\`), that means the person turned off call notes for their brief — say so plainly and neutrally (e.g. "Call notes are off for this brief."), never as an error, failure, or missing data.
