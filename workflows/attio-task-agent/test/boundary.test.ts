...
// instance without a wrapper contract. The tool package this workflow
// expects at deploy time (@corbits/mcp-tools) is pinned by name, never
// imported here — see src/index.ts's header comment.
