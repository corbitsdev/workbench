...
// Declarative step -> component mapping: which block renders the `intake`
// gate, colocated with the step definition it describes instead of a
...
// STEP_UI-driven run and a panel-driven run hand the pipeline the identical
// shape. Consumed generically by `blocksFromStepUI` (@workbench/blocks) — no
