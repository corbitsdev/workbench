...
//
// WORKBENCH-LOCAL: the workbench vendors `@workbench/storage-isogit`
// (a fork of `@intx/storage-isogit`, see docs/VENDORED.md) so the hub
// and sidecar consume a byte-identical pack/repo format; this store
// imports the vendored package rather than the upstream one.
