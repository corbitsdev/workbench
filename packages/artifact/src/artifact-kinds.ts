...
export type LinkedInPostArtifactKind = (typeof LINKEDIN_POST_ARTIFACT_KINDS)[number];

const LINKEDIN_POST_KIND_SET = new Set<string>(LINKEDIN_POST_ARTIFACT_KINDS);

export function isLinkedInPostArtifactKind(kind: string): kind is LinkedInPostArtifactKind {
