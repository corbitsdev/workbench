...
export function ArtifactCard({ artifact, index, onOpen }: ArtifactCardProps) {
  ...
  return (
    ...
    >
      ...
      <div className={`relative grid flex-1 place-items-center overflow-hidden ${artifact.fill}`}>
      ...
      <div className="border-t border-border bg-surface px-[13px] py-[11px]">
        <div className="truncate text-[13.5px] font-semibold text-text">{artifact.title}</div>
