...
const KIND_VISUALS: Record<string, ArtifactVisual> = {
  ...
  'follow-up-email': { label: 'Email', viz: 'lines', fill: 'bg-orange', span: 'row-span-3' },
  linkedin: { label: 'Post', viz: 'lines', fill: 'bg-blue', span: 'row-span-2' },
  'pain-points-linkedin-post': { label: 'Post', viz: 'lines', fill: 'bg-blue', span: 'row-span-2' },
  'pain-points-twitter-post': { label: 'Post', viz: 'lines', fill: 'bg-blue', span: 'row-span-2' },
  ...
  'sales-one-pager': { label: 'Document', viz: 'deck', fill: 'bg-charcoal', span: 'row-span-4' },
  'pain-points-blog': { label: 'Document', viz: 'deck', fill: 'bg-charcoal', span: 'row-span-4' },
  'case-study-draft': { label: 'Document', viz: 'deck', fill: 'bg-charcoal', span: 'row-span-4' },
