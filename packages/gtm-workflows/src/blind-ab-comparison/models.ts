...
export type AbComparisonProviderPlugin = (typeof AB_COMPARISON_PROVIDER_PLUGINS)[number];
...
export const OPENAI_AB_COMPARISON_MODELS = ['gpt-5.5', 'gpt-5.4', 'gpt-5.4-mini'] as const;
