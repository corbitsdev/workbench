...
//
// UI-only (CL-7588): catalog writes go through the tenant-admin catalog
// routes behind a browser session, never through a workflow child, so
// this client exposes no write surface — the reads above are the whole API.
