...
export const LOAD_SKILL_DEFINITION: ToolDefinition = {
  ...
  inputSchema: {
    ...
    properties: {
      id: {
        type: 'string',
        description: 'The skill id to load, as returned by list_skills or search_skills.',
      },
    },
    required: ['id'],
  },
 ...
 */
export function skillMatchesQuery(entry: SkillIndexEntry, query: string): boolean {
