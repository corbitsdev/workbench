...
function parseVideoItem(value: unknown): YouTubeVideoItem {
  ...
  return {
    ...
    statistics: {
      viewCount:
        typeof stats.viewCount === "string" ? stats.viewCount : undefined,
      likeCount:
        typeof stats.likeCount === "string" ? stats.likeCount : undefined,
      commentCount:
        typeof stats.commentCount === "string" ? stats.commentCount : undefined,
    },
  };
}
