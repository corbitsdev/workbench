...
function buildAgentDefinitionDraftPrompt(
  ...
  return [
    ...
    "with no prior context, then ask what it's for — offering, in plain",
    "words, three shapes it could take: a standing job it runs on a",
    "routine, a one-off task, or simply being around to chat with",
    "whenever needed. Every",
