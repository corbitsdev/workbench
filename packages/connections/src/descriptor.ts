...
export interface ConnectorOAuthConfig {
  ...
  readonly clientId?: (env: Readonly<Record<string, string | undefined>>) => string | undefined;
  ...
  readonly clientSecret?: (env: Readonly<Record<string, string | undefined>>) => string | undefined;
