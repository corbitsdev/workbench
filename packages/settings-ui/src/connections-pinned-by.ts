...
// and siblings, each exporting a *_TOOL_PACKAGE_PINS const). This is a
// hand-maintained approximation, not a live query against deployed
// definitions — the settings-ui card labels it "Used by workflows:" for
// readability, but carries the approximation caveat on a title/tooltip
