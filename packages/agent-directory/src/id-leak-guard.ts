// The systemic guard this module enforces: a person never sees an internal
...
// Myra reply, and its own "Run 737a058d…" / "I'm run_737a…") each
...
// the six kinds this guard names explicitly — a workflow run, a workflow
...
// `_`: `humanizeSlug`'s Title Case reading of a leaked id (its own
