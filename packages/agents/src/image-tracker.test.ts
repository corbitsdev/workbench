...
describe("createImageTracker", () => {
  it("starts with an empty images list", () => {
    ...
    const tracker = createImageTracker(transport, {
      tenantId: "t1",
      instanceId: "i1",
    });
  ...
  it("accumulates multiple images within a turn", () => {
    ...
    push({
      ...
      data: {
        image: {
          type: "image",
          source: { kind: "base64", mimeType: "image/png", data: "img1" },
        },
      },
    });
    push({
      ...
      data: {
        image: {
          type: "image",
          source: { kind: "base64", mimeType: "image/jpeg", data: "img2" },
        },
      },
    });
  ...
  it("calls onUpdate when an image is received", () => {
    ...
    push({
      ...
      data: {
        image: {
          type: "image",
          source: { kind: "base64", mimeType: "image/png", data: "x" },
        },
      },
    });
