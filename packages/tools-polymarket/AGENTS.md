# @workbench/tools-polymarket

Polymarket prediction market tools. Registered in the hub's tool registry as `polymarket_*`.

- Keyless — uses the public Polymarket API; no credential required and no seed entry needed
