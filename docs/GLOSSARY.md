...
| **Agent**        | principal (agent)   | A named coworker identity, listed under Agents; opening the row reopens that agent's one DM                                                                                                                                                                                                                                                                         |
| **DM**           | kind: chat          | The one 1:1 tenant with that agent — two opens never clone a second DM                                                                                                                                                                                                                                                                                              |
| **Channel**      | kind: workbench     | A multi-principal tenant. `+` mints an empty one with nobody hosted; named templates mint the same empty channel, then invite existing principals                                                                                                                                                                                                                   |
...
| **Workbenches**  | —                   | The product noun for conversation tenants. The sidebar lists them as Agents (DMs) then Channels (rooms), not one recency list                                                                                                                                                                                                                                       |
