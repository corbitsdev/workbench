...
| **Working**      | —                                                  | The Spaces band's group for the signed-in user's tasks still in progress; a task leaves it the instant it completes or fails, since its result has moved to the Inbox                                                                               |
