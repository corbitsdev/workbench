...
| **Agents**       | —                   | The left-rail section for agent conversations and unopened conversational definitions in the selected bench                                                                                                                                                                                                                                                         |
| **Channels**     | —                   | The left-rail section for rooms (multi-party workbenches) in the selected bench; pinning stays inside this section, never mixed with Agents                                                                                                                                                                                                                         |
