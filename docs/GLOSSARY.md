...
| **Channel**      | kind: workbench     | A shared room between people and agents (multi-principal tenant). `+` mints an empty one with nobody hosted; named templates mint the same empty channel, then invite existing principals                                                                                                                                                                          |
